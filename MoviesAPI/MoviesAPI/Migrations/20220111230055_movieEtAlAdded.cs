...
{
    public partial class movieEtAlAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieTheatresMovies", x => new { x.MovieTheatreId, x.MovieId });
                    table.ForeignKey(
                        name: "FK_MovieTheatresMovies_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieTheatresMovies_MovieTheatres_MovieTheatreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieTheatresMovies_MovieId",
                table: "MovieTheatresMovies",
                column: "MovieId");
        }
